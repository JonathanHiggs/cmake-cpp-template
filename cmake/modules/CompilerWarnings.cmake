...
message(TRACE "mylib::CompilerWarnings")
...
if (MYLIB_ENABLE_WARNINGS_AS_ERRORS)
    ...
    target_compile_options(
        mylib_base_target
        INTERFACE
            $<$<BOOL:${MYLIB_COMPILER_CLANG}>:-Werror>
            $<$<BOOL:${MYLIB_COMPILER_CLANGCL}>:-Werror>
            $<$<BOOL:${MYLIB_COMPILER_GCC}>:-Werror>
            $<$<BOOL:${MYLIB_COMPILER_MSVC}>:/WX>
    )
endif()